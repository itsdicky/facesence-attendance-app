...
import '../cubit/permission/load_permission/load_permission_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<LoadPermissionCubit>(create: (context) => di.sl<LoadPermissionCubit>()..getCurrentUserPermissions(),),
      ],
      child: Scaffold(
